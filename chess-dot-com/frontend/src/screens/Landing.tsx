        ...
        <div className="flex flex-col md:flex-row w-full gap-x-16">
          {
            currentTheme ? (
              <img
                className="rounded-md w-full h-162.5 hidden md:block"
      ...
      <div className="mt-32 bg-bgAuxiliary2 text-textMain w-full px-14 py-14 rounded-[36px]">
        <div className="lg:grid grid-cols-[45%,1fr] gap-28">
            <div className="rounded-xl">
                {/* <img src="/chessboard.jpeg" alt="chess-board" /> */}
            </div>
            <div className="mt-16 lg:mt-0">
                <h1 className="text-6xl font-bold text-left -mt-2.5">Found an Issue?</h1>
                ...
                <a 
                    ...
                    >
                    <img className="w-16 h-16" src="github.svg" alt="icon"/>
